...
from .plate_geometry import order_quad_points, rectify_plate_quad
...
def rectify_plate(image, corners) -> np.ndarray | None:
    ...
    return rectify_plate_quad(image, corners)
    ...
    try:
        ...
        for row in decoded:
            ...
            results.append({
                ...
                "quadrilateral": corners.tolist(),
                "confidence": row["confidence"],
                "angle": row["angle"],
                "method": runtime,
                "crop_geometry": "perspective",
