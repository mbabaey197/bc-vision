...
- GitHub repository: `mbabaey197/bc-vision`
- Default branch: `main`
- Product: BC Vision
- Current application version in source: `2.2.0-rc28`
...
Starting with `2.2.0-rc28`, BC Vision has no product activation, hardware
binding, trial period, commercial plan gate or software camera-count limit.
Legacy activation files are ignored and are not copied into new builds. Model
signature verification and third-party model/data licensing controls remain
independent security and distribution requirements.
